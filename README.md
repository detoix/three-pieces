...
takes the clouds' shadows off the lawn and the hills, `?cloudcoverage=` and
`?cloudwind=` (the demo runs at 0.1 and 4 m/s, sparser and calmer than the
sky's own defaults of 0.48 and 12 m/s), and `?msaa=off`, which
